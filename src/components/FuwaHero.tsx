...
export const FuwaHero: React.FC<FuwaHeroProps> = ({ activeSection }) => {
  ...
  if (!wide) {
    ...
    return (
      <div className="glass-t1 rounded-[28px] relative flex items-center gap-4 px-5 py-2.5 overflow-hidden shrink-0">
  ...
  return (
    <div className="glass-t1 rounded-[28px] relative flex flex-col items-center justify-center overflow-hidden px-6 pt-8 pb-6 h-full">
      ...
      <FuwaFaceMascot face={face} width={160} className="fuwa-bob relative" />
      <h2 className="font-display font-semibold text-3xl mt-2 tracking-tight relative text-center">
        {t(KEYS[state].title)}
      </h2>
